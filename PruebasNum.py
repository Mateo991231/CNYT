...
class TestCases(unittest.TestCase):
    def test_DeberiaSumar(self):
        self.assertEqual(complexCal.suma(-3,7,7,-2),(4, 5))
    def test_DeberiaRestar(self):
        self.assertEqual(complexCal.resta(-3,7,7,-2),(-10,9))
    def test_Deberiamultiplicar(self):
        self.assertEqual(complexCal.multiplicacion(1,2,-1,-3),(-1,-5))
    def test_deberiaHacerDivision(self):
        self.assertEqual(complexCal.divi(10,20,30,5),(0.8235294117647058,1.2941176470588236))
